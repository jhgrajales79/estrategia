...
((select id from sessions where code='S0'), 'El tejido de conexiones', 15,
...
((select id from sessions where code='S0'), 'Radar exprés del contexto', 15,
...
((select id from sessions where code='S0'), 'Revisión del acumulado anual', 15,
...
((select id from sessions where code='S0'), 'Crazy 8 Socya: ocho ideas en ocho minutos', 15,
...
((select id from sessions where code='S0'), 'Cierre y compromisos de información', 10,
