  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-6 text-2xl font-bold text-foreground sm:text-3xl">Ruta de Planeación Estratégica</h1>
        ...
        <Link href="/ingresar" className="mt-6 inline-flex items-center gap-2 rounded-md bg-brand px-5 py-2.5 text-sm font-semibold text-white hover:bg-brand-dark">
